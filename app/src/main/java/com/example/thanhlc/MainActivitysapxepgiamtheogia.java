...
public class MainActivitysapxepgiamtheogia extends AppCompatActivity {
    GridView gridView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activitysapxepgiamtheogia);
        gridView=findViewById(R.id.grid_sapxepgiam);

        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MainActivitysapxepgiamtheogia.this, MainActivitychitiet.class);
