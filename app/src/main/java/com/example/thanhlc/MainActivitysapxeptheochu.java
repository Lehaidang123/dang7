...
public class MainActivitysapxeptheochu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activitysapxeptheochu);
        gridView=findViewById(R.id.grid_sapxeptheochu);

        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MainActivitysapxeptheochu.this, MainActivitychitiet.class);
