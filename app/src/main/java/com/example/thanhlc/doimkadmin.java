        ...
        user.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                        ...
                        if (passcheck.equals(md5(khau))) {
                            if(newpass.equals(password)) {
                                if(newpass.length()>=8) {
                                    ...
                                    Toast.makeText(doimkadmin.this, "Đôi Mật Khẩu Thành Công", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(doimkadmin.this, MainActivity.class);
                                    startActivity(intent);
                                }else {
                                    Toast.makeText(doimkadmin.this, "Password phải trên 8 ki tự", Toast.LENGTH_SHORT).show();
                                }
                            }
                            else {
                                Toast.makeText(doimkadmin.this, "Pass Hoặc pass mới không đúng", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(doimkadmin.this, "Pass Hoặc pass mới không đúng", Toast.LENGTH_SHORT).show();
                        }
                    ...
                    Toast.makeText(doimkadmin.this, "Vui lòng điền đầy đủ thông tin!!!", Toast.LENGTH_SHORT).show();
                }
            }
